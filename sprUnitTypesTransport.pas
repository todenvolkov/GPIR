...
begin
  ...
  if not(Assigned(TypesTransportForm)) then // Если еще не создана
    begin
      try
  ...
  if (FormCreatedOrExists = true) then
    ...
    begin
      ...
      OpenParamsQ(TypesTransportForm.Adoquery1,'exec TypesTransportShow :BudgetGUID, :FormType', [GlobalBudgetGUID, #39 + 'Справочник' + #39]);
