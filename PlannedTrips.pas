...
begin
  try
    ...
    OpenParamsQ(CostResidingQ, 'exec CostResidingShow :BudgetGUID, :FormType', [BudgetGUIDForSpr, 'Форма ввода']);
    OpenParamsQ(CostTripQ, 'exec CostsTripShow :BudgetGUID, :FormType', [BudgetGUIDForSpr, 'Форма ввода']);
    OpenParamsQ(DailyAllowanceQ, 'exec DailyAllowancesShow :BudgetGUID, :FormType', [BudgetGUIDForSpr, 'Форма ввода']);
...
procedure TPlannedTripsForm.ChangeFontSize(S: TcxGridTableViewStyles;
  SizeDifference: Integer = 0);
var
  i: Integer;
begin
...
begin
  if AItem = cxGrid1DBTableView1PostGUID then
    begin
      ...
      OpenParamsQ(PostFilterQ, 'exec PostsShow :BudgetGUID, :DepartmentGUID, :FormType', [BudgetGUIDForSpr, ItemValue, 'Форма ввода']);
...
//      PlaceResidenceFilterQ.Parameters.ParamByName('CityFinishGUID').Value := ItemValue;
      ...
      OpenParamsQ(PlaceResidenceFilterQ, 'exec PlaceResidenceShow :BudgetGUID, :CityGUID, :FormType', [BudgetGUIDForSpr, ItemValue, 'Форма ввода']);
