...
type
  TPlannedTripsShiftFormSelect = class(TForm)
    WorkQ: TADOQuery;
    WorkDS: TDataSource;
...
var
  PlannedTripsShiftFormSelect: TPlannedTripsShiftFormSelect;
  function ShowPlannedTripsShiftSelect(Options: CreateOptionsGlobal): Integer;
...
procedure TPlannedTripsShiftFormSelect.RefreshData;
...
begin
  try
    ...
    OpenQ(PlaceResidenceQ, 'exec PlaceResidenceShow ' + VariantAsString(BudgetGUID), False);
...
begin
  Result := -1;
  try
    Application.CreateForm(TPlannedTripsShiftFormSelect, PlannedTripsShiftFormSelect);
    PlannedTripsShiftFormSelect.Caption := Options.FormCaption;
    PlannedTripsShiftFormSelect.Show;
    Result := 1;
  except
    PlannedTripsShiftFormSelect.Free;
    PlannedTripsShiftFormSelect := nil;
  end;
end;

procedure TPlannedTripsShiftFormSelect.btnDecreaseFontClick(Sender: TObject);
begin
...
procedure TPlannedTripsShiftFormSelect.btnIncreaseFontClick(Sender: TObject);
begin
cxGrid1DBTableView1.BeginUpdate;
  with cxGrid1DBTableView1.Styles do
    begin
...
procedure TPlannedTripsShiftFormSelect.btnWordWrapClick(Sender: TObject);
begin
  cxGrid1DBTableView1.optionsView.CellAutoHeight :=
    not(cxGrid1DBTableView1.optionsView.CellAutoHeight);
end;

procedure TPlannedTripsShiftFormSelect.ChangeFontSize(S: TcxGridTableViewStyles;
  SizeDifference: Integer = 0);
var
  i: Integer;
begin
...
procedure TPlannedTripsShiftFormSelect.cxButton1Click(Sender: TObject);
begin
  messagedlg('Экспорт в Excel', mtConfirmation, [mbYes], 0);
end;

procedure TPlannedTripsShiftFormSelect.cxButton2Click(Sender: TObject);
begin
  messagedlg('Печать', mtConfirmation, [mbYes], 0);
end;

procedure TPlannedTripsShiftFormSelect.cxGrid1DBTableView1CustomDrawCell
...
procedure TPlannedTripsShiftFormSelect.cxGridDBTableView1FocusedRecordChanged(Sender: TcxCustomGridTableView;
...
procedure TPlannedTripsShiftFormSelect.FormActivate(Sender: TObject);
begin
  MainForm.ActivateTab(MainForm.TabSet, TForm(Sender));
end;

procedure TPlannedTripsShiftFormSelect.FormClose(Sender: TObject;
...
procedure TPlannedTripsShiftFormSelect.FormShow(Sender: TObject);
begin
...
procedure TPlannedTripsShiftFormSelect.WorkQAfterPost(DataSet: TDataSet);
begin
...
procedure TPlannedTripsShiftFormSelect.WorkQBeforePost(DataSet: TDataSet);
begin
  RL.ErrorState := False;
...
procedure TPlannedTripsShiftFormSelect.WorkQPostError(DataSet: TDataSet;
...
procedure TPlannedTripsShiftFormSelect.btnAddRecordClick(Sender: TObject);
begin
  try
    ...
    MainForm.Query.Parameters.ParamByName('FormName').Value := 'PlannedTripsShift';
...
procedure TPlannedTripsShiftFormSelect.btnColumnAutoWidthClick(Sender: TObject);
begin
